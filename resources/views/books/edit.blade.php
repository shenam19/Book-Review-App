                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control  @error('title') is-invalid   @enderror" placeholder="Author"  name="author" id="author" value="{{old('author',$book->author)}}"/>
                            @error('author')
                            <div class="invalid-feedback">{{$message}}</div>
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            @if (!empty($book->image))
                            <img class="w-50 my-3" src="{{asset('uploads/books/thumb/'.$book->image)}}" alt="">
