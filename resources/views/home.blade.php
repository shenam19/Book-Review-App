                    ...
                    <form action="" method="GET">
                        ...
                        <div class="row">
                            <div class="col-lg-11 col-md-11">
                                <input type="text" class="form-control form-control-lg"name="keyword" value="{{Request::get('keyword')}}"  placeholder="Search by title">
                            </div>
                ...
                <div class="col-md-4 col-lg-3 mb-4">
                    <div class="card border-0 shadow-lg">
                        <a href="{{route('book.detail',$book->id)}}">
                            ...
                            @else
                            <img src="https://placehold.co/910x1400?text=No Image" alt="Placholderimage" class="card-img-top">
