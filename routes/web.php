...
Route::group(['prefix' => 'account'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::get('reviews', [ReviewController::class, 'index'])->name('account.reviews')->middleware('admin.middleware');
        ...
        Route::post('delete-review', [ReviewController::class, 'delete'])->name('account.reviews.deleteReview');
        ...
        Route::post('delete-myReview', [AccountController::class, 'deleteReview'])->name('account.myReviews.deleteReview');
    });
});
